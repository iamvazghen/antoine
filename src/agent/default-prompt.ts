...
// Kept out of prompts.ts because prompts.ts imports the whole tool registry:
// model/llm.ts wants only this constant, and importing it from there put every
// tool file inside a prompts -> registry -> tool -> llm -> prompts cycle.
/**
