...
import { getAntoineDir } from './paths.js';
 ...
 * Stores messages in .antoine/messages/chat_history.json
 */
export class LongTermChatHistory {
  ...
  constructor(baseDir: string = process.cwd()) {
    this.filePath = join(baseDir, getAntoineDir(), MESSAGES_DIR, MESSAGES_FILE);
  }
